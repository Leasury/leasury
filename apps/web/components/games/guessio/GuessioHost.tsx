...
export default function GuessioHost({ state }: GuessioHostProps) {
    ...
    return (
        <GameLayout backUrl="/games/guessio" theme="light">
            <div className="flex flex-col items-center justify-center p-8 bg-background min-h-screen font-sans">
                    ...
                    {room.status === 'waiting' && (
                        <div className="text-center">
                            ...
                            <button
                                ...
                                className="bg-accent hover:bg-accent-hover disabled:bg-muted disabled:cursor-not-allowed text-accent-foreground text-xl font-bold py-4 px-8 rounded-2xl transition-all"
                            >
