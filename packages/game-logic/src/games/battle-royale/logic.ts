...
export function createInitialBattleRoyaleState(
    ...
    const colors = shuffleArray([...BR_PLAYER_COLORS]);
    const players: Record<string, BattleRoyalePlayer> = {};
...
export function applyBattleRoyaleMessage(
    state: BattleRoyaleGameState,
    msg: BattleRoyaleMessage,
    senderId?: string,
    ...
    switch (msg.type) {
        ...
        case 'play_again': {
            const playerIds = Object.keys(state.players);
            return createInitialBattleRoyaleState(
                playerIds,
                state.arena.size,
...
function startResolution(state: BattleRoyaleGameState): BattleRoyaleGameState {
...
function startNextRound(state: BattleRoyaleGameState): BattleRoyaleGameState {
