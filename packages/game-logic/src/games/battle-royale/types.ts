...
export interface ResolutionStep {
    ...
    players: Record<string, BattleRoyalePlayer>;
    grid: CellState[][];
    events: RoundEvent[];
}
...
export interface BattleRoyaleGameState {
    phase: Phase;
    round: number;
    arena: ArenaConfig;
    grid: CellState[][];
...
export const BR_PLAYER_COLORS: PlayerColor[] = ['blue', 'green', 'purple', 'yellow'];
...
export type BattleRoyaleMessage =
